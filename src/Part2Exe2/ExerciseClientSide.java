...
/***
 *  Lab exercise of client-side application using UDP
 * @author yungh
 *
 */
public class ExerciseClientSide {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String text = "Goodbye Malaysia, Singapore, Vietnam.";
			...
			System.out.println("\tMessage from the server is : " + length);
